...
import '../../domain/use_cases/location_manager.dart';
...
class LocationController extends GetxController {
  ...
  Future<void> deleteLocation({required TrackedLocation location}) async {
    ...
    /* TODO: Con [.delete] elimina la ubicacion y luego usa [removeWhere] para eliminar la ubicacion de [_locations.value] usando [_locations.update de GetX] */
